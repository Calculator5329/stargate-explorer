...
export const PALETTES = {
  /** Ethan's reference frame: cream hull, red stripes, charcoal underside, blue plumes. */
  tauri: { body: 0xe9e3d4, accent: 0xc9362c, dark: 0x2a2d33, glow: 0x4fa3ff, canopy: 0x143a4c },
