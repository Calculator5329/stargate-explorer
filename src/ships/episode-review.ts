...
const episodes:Episode[]=[
  ...
  {id:'antarctica',name:'The Antarctic defense',episode:'Lost City, Part 2 · S7 E22',summary:'A low-altitude battle with an enormous fleet hanging above the ice. This is the centerpiece.',idea:'Escort the cargo ship to the drilling site, peel attackers off Prometheus, then hold the airspace long enough for the drone salvo. The choice later is whether this is one long mission or several connected sorties.',visual:'Blue-white pressure ridges, a dark ship wall overhead, F-302s crossing the foreground and a rising fan of gold drone trails. The excavation and placements here are interpretive scenery.',canon:'The team reaches the Antarctic outpost in a cargo ship; Prometheus and F-302s defend it against Anubis’s forces. Ancient drones decide the battle. Our fighter objectives are proposed adaptations.',source:'https://rdanderson.com/stargate/episodes/episodes/07-21lost.htm',fleet:['fighter','cargo','prometheus','glider','bomber','pyramid','flagship'],scene:'polar'},
  ...
  {id:'fallen',name:'Under the shield',episode:'Fallen · S7 E1',summary:'Make a capital ship feel like terrain: deck trenches, pylons and a small target at the end of a dangerous approach.',idea:'A precision pass along Anubis’s hull toward the superweapon’s vulnerable cooling vent. A route that rewards the new powered stunts could be interesting, provided the camera keeps the route readable.',visual:'The flagship’s radial arms become canyons at fighter height. Gold plates and deep black recesses provide a much different route than another asteroid belt.',canon:'The F-302 attack uses a short hyperspace jump to bypass the ship’s shields and strike the cooling vent. A flyable trench course would be our adaptation.',source:'https://rdanderson.com/stargate/episodes/episodes/07-01fallen.htm',fleet:['fighter','superweapon'],scene:'strike'},
