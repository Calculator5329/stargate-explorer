...
## Known issues
- **Awaiting Ethan's verdict on round 2** (2026-09-04): arcade vs classic controls, and the palette pass in `docs/shots/2026-09-04b-*.png`. Ethan's two reference frames are still not in `docs/refs/`.
