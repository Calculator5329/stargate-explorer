...
- [ ] Not done tonight: derelict wreckage as an obstacle type. *(2026-09-04: ice shards landed as a belt style with Kheb and the shard run; gamepad landed later the same night; the deeper map (five systems, gate travel), the gunboat and the ring race with AI racers all landed, see M3/M4.)*
