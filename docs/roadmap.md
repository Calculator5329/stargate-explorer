...
- [ ] Calibrate the power model against real flights: `editor/power.ts` has three constants (`HIT`, `ACC`, `EXPOSURE`) set by feel; a headless fight that measures hull lost per glider would pin them.
