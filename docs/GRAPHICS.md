...
2. **Three-tone palette per ship** — cream body, gold accents, charcoal underside/engines — with almost no hue variation within a tone. Cyan is reserved for canopy + plume.
