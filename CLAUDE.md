...
src/
  ...
  mission/ levels (data), mission (base + Waves), runners clear/run/protect/strike/race/hold/duel/hunt/intercept (race and hunt extend run; protect takes any hull in ships/hulls.ts as the escort; hold and intercept outlast a clock; duel is free play with ?foe=; hunt and intercept drive enemies through Enemy.steer), index (factory)
