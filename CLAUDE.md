...
src/
  ...
  mission/ levels (data), mission (base + Waves), runners clear/run/protect/strike/race/hold (race extends run: AI racers on the gate chain; protect takes any hull in ships/hulls.ts as the escort; hold outlasts a clock), index (factory)
